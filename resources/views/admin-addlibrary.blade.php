            ...
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Thêm thư viện
                  </li>
                </ol>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-form-center">Thêm thư viện</h4>
                        ...
                        <div class="col-md-6 offset-md-3">
                          <div class="form-body collapse in">
                            <div class="form-group">
                              ...
                              <input type="text" id="eventInput1" class="form-control" name="library" value="{{old('library')}}">
