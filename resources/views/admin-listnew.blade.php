          ...
          <div class="content-body"><!-- Description -->
              <section id="description" class="card">
                  <div class="card-header">
                      ...
                      <button class="btn btn-success" onclick="window.location = '/admin/news/add'" style="float:right;color:white">Thêm</button>
                  </div>
                          ...
                          <table id="dbtable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button onclick="window.location = '/admin/news/edit/{{$item->id}}'" class="btn btn-warning">Sửa</button></td>
