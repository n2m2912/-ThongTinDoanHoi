            ...
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="/user/news">Danh sách tin</a>
                  </li>
              ...
              <div class="card">
                ...
                <div class="card-body collapse in">
                  <div class="card-block">
                    <form class="form" method="POST" action="{{route('useraddNew')}}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      <div class="row">
                        <div class="col-md-6 offset-md-3">
                          <div class="form-body collapse in">
                            ...
                            <div class="form-group">
                              ...
                              <textarea id="eventInput2" class="ckeditor" id="editor" name="content" value="{{old('content')}}"></textarea>
                              <script>
                      ...
                      <div class="form-actions center">
                        <button type="button" onclick="window.location='/user/news'" class="btn btn-warning mr-1">
